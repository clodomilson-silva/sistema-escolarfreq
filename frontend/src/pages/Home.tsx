        ...
        <div className="row">
          <div className="col-12 text-center mb-5">
            ...
            <p className="lead text-muted">
              ...
              Gerencie alunos e turmas de forma eficiente.
            </p>
          </div>
        </div>
            ...
            >
              <div className="card-body text-center p-4">
                ...
                <p className="card-text text-muted">
                  Visualizar, adicionar e editar informações dos alunos matriculados
                </p>
                <div className="mt-3">
          ...
          <div className="col-md-6">
            ...
            >
              <div className="card-body text-center p-4">
                ...
                <p className="card-text text-muted">
                  Criar e organizar turmas para acompanhamento de frequência e autorizações
                </p>
                <div className="mt-3">
        ...
        <div className="row mt-5">
          <div className="col-12">
            <div className="alert alert-info text-center">
              ...
              <p className="mb-0">
                Apenas administradores autenticados podem acessar as funcionalidades do sistema.
                Todas as operações são protegidas e registradas para auditoria.
              </p>
            </div>
          </div>
        </div>
